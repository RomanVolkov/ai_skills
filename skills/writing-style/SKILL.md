...
For these, follow the **Public-Facing Docs** rules below (proper English, full sentences) — not the terse technical-comment style.
...
# Public-Facing Docs (README, guides, blog posts)

For README.md, user guides, API docs, tutorials, and other public content, use proper English — complete sentences, proper capitalization, no abbreviations. The brevity and anti-AI-speak rules above still apply; the difference is full sentences instead of fragments.

## Prose

- **Proper English** — full sentences, correct capitalization, no shorthand.
- **Active voice** — "the script collects metrics", not "metrics are collected by the script".
- **Concise** — say it in fewer words; an overview is roughly 200-400 words, not pages.
- **Lead with substance** — state what the project is, who it is for, and what it does. Skip build-up.
- **No marketing or AI-speak** — drop "comprehensive", "robust", "seamless", "powerful", "compelling", "engaging", and the filler/hedging/transition patterns listed above. State facts.
- **No adjective padding** — prefer the noun/verb over decorating it (write "planning skill", not "powerful planning skill").

## Markdown formatting for docs

- ATX-style headers (`#`, `##`), not underline-style.
- Blank line before every list and code block.
- Code fences with a language specifier (```bash, ```python, …).
- Keep lines under ~120 characters where practical.
- Relative links for internal docs; absolute links for external.
- Add a table of contents for long documents (>500 lines).
...
**REMINDER**: The terse style (fragments, no articles where natural) applies to technical communication (tickets, PRs, code reviews, commits). For README.md, public docs, and blog posts, use the **Public-Facing Docs** rules above — proper English, full sentences, same brevity and no-AI-speak discipline.
