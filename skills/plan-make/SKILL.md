...
```json
{
  "questions": [{
    ...
    "options": [
      ...
      {"label": "Execute autonomously", "description": "Commit plan and run /plan-exec for autonomous execution with reviews"},
...
- **Interactive review**: run `python3 ${SKILL_DIR}/scripts/plan-annotate.py <plan-file-path>` via Bash.
