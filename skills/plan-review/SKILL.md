---
name: plan-review
description: "Use this agent PROACTIVELY after creating implementation plans with /plan-make to review plan quality before execution. Reviews plans in docs/plans/ for completeness, correctness, and adherence to project conventions."
model: opus
